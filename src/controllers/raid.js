	...
	async handle(data) {
		return new Promise((resolve) => {
			...
			if (data.pokemon_id) {
				...
				data.move1emoji = moveData[data.move_1] && moveData[data.move_1].type && typeof types[moveData[data.move_1].type] !== 'undefined' ? types[moveData[data.move_1].type].emoji : ''
				data.move2emoji = moveData[data.move_2] && moveData[data.move_2].type && typeof types[moveData[data.move_2].type] !== 'undefined' ? types[moveData[data.move_2].type].emoji : ''
